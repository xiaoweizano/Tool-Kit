...
TBD — created by syncing `openspec/changes/batch-and-translate-tools`. Covers the networked multi-engine translation tool (`translate`), including language support, line-by-line translation, engine adapters with API keys, offline/error degradation, NET capability badge, and pure-function layering.
